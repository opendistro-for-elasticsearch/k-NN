...
#include <jni.h>
/* Header for class com_amazon_opendistroforelasticsearch_knn_index_faiss_v164_KNNFIndex */

#ifndef _Included_com_amazon_opendistroforelasticsearch_knn_index_faiss_v164_KNNFIndex
#define _Included_com_amazon_opendistroforelasticsearch_knn_index_faiss_v164_KNNFIndex
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_amazon_opendistroforelasticsearch_knn_index_faiss_v164_KNNFIndex
 * Method:    saveIndex
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_amazon_opendistroforelasticsearch_knn_index_faiss_v164_KNNFIndex_initLibrary
  (JNIEnv *, jclass);
