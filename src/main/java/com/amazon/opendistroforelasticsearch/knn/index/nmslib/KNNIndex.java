...
package com.amazon.opendistroforelasticsearch.knn.index.nmslib;
 ...
 * This class refers to the nms library build with version tag 2.0.7
 * See <a href="https://github.com/nmslib/nmslib/tree/v2.0.7">tag2.0.7</a>
 */
public class KNNIndex implements AutoCloseable {
    public static NmsLibVersion VERSION = NmsLibVersion.V207;
    ...
    // Calls nmslib's initLibrary function: https://github.com/nmslib/nmslib/blob/v2.0.7/similarity_search/include/init.h#L27
